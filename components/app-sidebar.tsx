...
const menuItems = [
  ...
  },
  {
    ...
    icon: TrendingUp,
    items: [
      { title: "All Bookings", url: "/sales-v2" },
      { title: "Payment Collection", url: "/sales-v2/payments" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Expense Heads / Groups", url: "/finance/expense-heads" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Role Manager", url: "/role-manager" },
    ],
  },
  {
