...
export const debitVoucherSchema = baseVoucherSchema.extend({
  ...
  billNo: z.string().optional(),
  amount: z.coerce.number().positive("Amount must be greater than 0"),
  partyType: z.enum(["vendor", "contractor", "other"]).default("vendor"),
  vendorId: z.coerce.number().optional(),
  vendorName: z.string().optional(),
  constructorId: z.coerce.number().optional(),
  referencePartyType: z.string().optional(),
  referencePartyName: z.string().optional(),
  paymentMethod: z.string().optional(),
  chequeNumber: z.string().optional(),
  chequeDate: z.string().optional(),
  qty: z.string().optional(),
